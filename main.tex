...
\author{Aaron Feickert\inst{1}\thanks{Corresponding author: \email{aaron@cypherstack.com}} \and Aram Jivanyan\inst{2,3}}
\institute{Cypher Stack \and Firo \and Yerevan State University}
\maketitle
...
The parallel one-of-many proving system definition used in Spark may be modified to support extended commitments.
